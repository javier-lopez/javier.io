...
Last weekend I installed a usb hard disk to my [openwrt](https://openwrt.org/) [router](/blog/en/2017/11/23/installing-openwrt-as-wireless-repeater.html), added some content, setup [minidlna](https://wiki.openwrt.org/doc/uci/minidlna) and called it a day, easy way to stream movies locally. I tested the setup with all my endpoints and while it worked great with most of them I was having problems streaming to my Linux laptop, that's funny considering the router itself runs the same OS.
