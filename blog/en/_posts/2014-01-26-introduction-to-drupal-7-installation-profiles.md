...
Feature modules are good for bundling configurations, permissions and dependencies on non default modules. I created **umx_conf** to iterate faster. Using a feature module you can modify drupal settings through a browser and then export the result to code from the feature menu.
...
Very few times you would need to modify them directly. In my experience (a weekend) the autogenerated files will sometimes contain mistakes, therefore I modified slighly to feet my needs:
...
I had to adjust mostly the **weight** parameter and add some missing links. Not difficult if you follow the sintax (even if you don't know php).

- [Introduction to drupal module features](http://www.youtube.com/watch?v=DxRBEaD9JCA)

That's it, I hope this information can save some hours to someone, have fun!
