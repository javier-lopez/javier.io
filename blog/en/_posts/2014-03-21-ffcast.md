...
title: "ffcast"
tags: [tools, shell]
description: "During the last days I've rewrote ffcast and package it (only for supported Ubuntu LTS versions) without an obvious reason. ffcast is a program to create screencasts. I've already written..."
---
...
**[![ffcast](/assets/img/ffcast.gif)](/assets/img/ffcast.gif)**
...
- [https://github.com/minos-org/ffcast](https://github.com/javier-lopez/ffcast) (personal one)
